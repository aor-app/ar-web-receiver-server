...
class ARReceiver extends ARReceiverCore {
    ...
    setSelectSquelch (value) {
        const task = async () => {
            const result = await super.setSelectSquelch(value);
            if ( result.resultCode != '20' ){
                return { code: -4, message: result.message };
            }
            return { code: 0 };
    ...
    getSelectSquelch () {
        const task = async () => {
            const result = await super.getSelectSquelch();
            if ( result ){
    ...
    setNoiseSquelch (value) {
        const task = async () => {
            ...
            const result = await super.setNoiseSquelch(param);
            if ( result.resultCode != '20' ){
                return { code: -4, message: result.message };
            }
    ...
    getNoiseSquelch () {
        const task = async () => {
            const result = await super.getNoiseSquelch();
            if ( result ){
                return { code: 0,  value: parseInt(result) };
            }
            return { code: 0,  value: result };
    ...
    getTTCSlot() {
        const task = async () => {
            const result = await super.getTTCSlot();
            return {code: 0, value: result };
        };
        return this.execTask(task);
    }
    setTTCSlot(value) {
        const task = async () => {
            const result = await super.setTTCSlot(value);
            if ( result.resultCode != '20' ){
                return { code: -4, message: result.message };
            }else{
                return { code: 0 };
